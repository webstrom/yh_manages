...
new _vue2.default({
	...
	methods: {
		ManageLogin: function ManageLogin() {
			var that = this;
			if (that.userName === '') {
			...
			var data = {
				...
				password: (0, _jsMd2.default)(that.password),
				imageCode: that.imageCode
			};
			console.log(data);
			$.ajax({
				url: _common2.default.manage_url + 'loginToken.htm',
				data: data,
				type: 'post',
				//dataType:'json',
				success: function success(res) {
					...
					console.log(alerts);
					if (Ress === 'true') {
						_common2.default.setLocalStorage('USERTOKEN', token);
		...
		Verification: function Verification(e) {
			var that = this;
			if (that.userName === '') {
				_common2.default.layerMsg('请输入用户名', 2);
				return false;
			}
			var data = {
				userName: that.userName
			...
			$.ajax({
				url: _common2.default.manage_url + 'genRegCode.htm',
				data: data,
				type: 'post',
				dataType: 'json',
				success: function success(res) {
					...
					if (res.success) {
						...
						_common2.default.layerMsg(res.errorMsg, 1);
					} else {
						_common2.default.layerMsg(res.errorMsg, 7);
					}
				},
		...
		Regain: function Regain() {
			...
			$.ajax({
				url: _common2.default.manage_url + 'genRegCodeRetry.htm',
				data: data,
				type: 'post',
				dataType: 'json',
				success: function success(res) {
...
/***/ 0:
/*!**************************************************************************************************************************************************************!*\
  !*** multi ./node_modules/_webpack-dev-server@3.1.14@webpack-dev-server/client?http://127.0.0.1:8088 (webpack)/hot/dev-server.js ./public/index/js/index.js ***!
  \**************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
module.exports = __webpack_require__(/*! E:\web\yh_manages\public\index\js\index.js */"./public/index/js/index.js");
