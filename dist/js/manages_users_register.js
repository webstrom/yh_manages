...
/***/ "./public/index/js/manages_users_register.js":
/*!***************************************************!*\
  !*** ./public/index/js/manages_users_register.js ***!
  \***************************************************/
...
new _vue2.default({
	...
	methods: {
										...
										option: function option(e) {
											...
											$.each(curr.address, function (i) {
												if (dataNew === curr.address[i].name) {
													_vue2.default.set(curr, 'addressChildren', curr.address[i].city);
												}
											});
										}
									}
		...
		AuthenticationList: function AuthenticationList() {
			var that = this;
			window.parent.layui.use('layer', function () {
				var layer = window.parent.layui.layer;
				var vm;
				layer.open({
					...
					success: function success(layero) {
						...
						vm = new _vue2.default({
							data: {
								list: [{ name: '运营商认证' }, { name: '京东认证' }, { name: '社保认证' }]
							},
							methods: {
								option: function option(e) {
									var curr = this;
		...
		ModificationLimit: function ModificationLimit() {
			var that = this;
			window.parent.layui.use('layer', function () {
				var layer = window.parent.layui.layer;
				layer.open({
...
/***/ 10:
/*!*******************************************************************************************************************************************************************************!*\
  !*** multi ./node_modules/_webpack-dev-server@3.1.14@webpack-dev-server/client?http://127.0.0.1:8088 (webpack)/hot/dev-server.js ./public/index/js/manages_users_register.js ***!
  \*******************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
module.exports = __webpack_require__(/*! E:\web\yh_manages\public\index\js\manages_users_register.js */"./public/index/js/manages_users_register.js");


/***/ })

/******/ });
//# sourceMappingURL=manages_users_register.js.map